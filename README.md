...
The Prototype - the main concept and what the group believes we can realistically deliver into a well design prototype that supports the problem space.
Future Functionality - additional functionality that will enhance the user’s experience of the mobile application.
...
An informal meeting with all parties involved where the problem can be discussed. This informal setting will minimize hostility as it allows all parties to provide input and suggest solutions or possible courses of action.  
The team leader, unless they are the party involved in the conflict, will intervene and act as an objective third party. The third party should ask each member to explain their problems/challenges and should then suggest solutions that may be agreeable to all parties. 
If the conflict is still not resolved the DECO3500 staff should be notified. 
...
All requirements are captured and understood by all members of the project team
Require access to a room for meetings and planning

26th Aug - 05 Sep
2. Design
Gima and Emma
Break down of requirements into realistic timeframes
Paper prototyping demonstration of main project concept in Week 8 Standup
Require access to Photoshop

06 Sep - 19th Sep
3. Development
Taylor and Rawan
Development of main requirements
Main interfaces to be built and with minimal functionality for Week 10 Standup
Most functionality to be completed for the Week 12 Standup
Will require access to computers and spaces for meetings

20 Sep - 16th Oct
4. Testing
Gima and Emma
User acceptance testing
Demonstrate key results of UAT in the Week 12 Standup
Will require access to computers and spaces for meetings.
Will also require users to complete testing

17th Oct - 25 Oct
5. Implementation
Deployment of project in preparation of due date
Additionally the completion of promotional material (video and video editing software required)
Require presentation screen for final prototype presentation
